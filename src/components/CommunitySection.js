      ...
      <div className="relative z-10 px-5 py-12 md:px-10 md:py-16 lg:px-[60px] lg:py-20 h-full">
        <div className="mx-auto flex w-full max-w-[1200px] h-full min-h-[440px] flex-col justify-between gap-10 md:min-h-[520px] md:gap-12 lg:min-h-[600px] lg:gap-16">
          <div className="max-w-[540px] lg:max-w-[560px] lg:pt-2">
            ...
            <p className="mt-3 text-lg font-bold leading-snug text-[#452815] md:mt-4 md:text-xl lg:text-[22px]">
              {t('subtitle')}
            </p>
          ...
          <div className="w-full max-w-[380px] lg:ml-auto lg:mr-0 lg:mb-2">
            <div className="rounded-2xl border border-white/50 bg-white/40 p-6 shadow-[0_8px_32px_rgba(69,40,21,0.08)] backdrop-blur-md md:p-8">
              <h3 className="text-lg font-bold leading-snug text-[#452815] md:text-xl">
                {t('cardTitle')}
              </h3>
              <p className="mt-3 text-sm leading-relaxed text-[#452815]/85 md:text-[15px] md:leading-6">
                {t('cardDescription')}
              </p>
              <a
                href={DISCORD_URL}
